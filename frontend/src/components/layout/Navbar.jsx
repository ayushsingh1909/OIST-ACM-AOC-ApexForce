...
import { FiUser, FiLogOut, FiHome, FiFileText, FiHelpCircle, FiClipboard, FiGrid, FiActivity } from "react-icons/fi";
...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-4 sm:px-6 py-3 bg-slate-900/80 backdrop-blur-md border-b border-slate-800 sticky top-0 z-50">
