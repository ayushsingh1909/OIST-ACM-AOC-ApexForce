  ...
  if (!results) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center">
        <p className="text-slate-500 mb-4">Results not available for this attempt.</p>
        <button onClick={() => navigate("/quiz")} className="text-[#4F46E5] hover:text-[#4F46E5]/80">
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center w-32 h-32 rounded-full bg-gradient-to-br from-[#4F46E5]/10 to-[#00D2C4]/10 border border-[#4F46E5]/20 mb-4">
      ...
      <div className="p-6 bg-white border border-slate-100 rounded-3xl shadow-lg mb-6">
        <h2 className="text-lg font-semibold text-slate-900 mb-4">Topic-by-Topic Accuracy</h2>
        <div className="space-y-4">
          {results.topicBreakdown?.map((tb) => (
            <div key={tb.topic}>
              <div className="flex justify-between text-sm mb-1">
                <span className="text-slate-600">{tb.topic}</span>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-900 mb-2">{q.questionText}</p>
                  <p className="text-sm">
      ...
      <div className="mt-6 text-center">
        <button
          onClick={() => navigate("/quiz")}
          className="px-8 py-3 bg-gradient-to-r from-[#4F46E5] to-[#00D2C4] text-white font-semibold rounded-2xl shadow-lg shadow-[#4F46E5]/25 hover:shadow-xl hover:shadow-[#4F46E5]/30 transition-all"
        >
          Take Another Quiz
        </button>
      </div>
