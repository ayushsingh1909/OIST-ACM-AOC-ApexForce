        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-4 font-sans">
            <button type="button" onClick={onClose}
              className="flex-1 px-4 py-3 text-xs border border-black/10 text-[#555555] rounded-xl hover:bg-black/5 font-semibold transition-all">
              Cancel
            </button>
...
const CareerDashboard = () => {
    ...
    const actions = [
      {
        ...
        cells: [
          ...
          <Link to="/growth-trend" className="inline-flex items-center gap-1 text-[10px] font-bold text-[#635BFF] uppercase tracking-wider font-mono">
      ...
      },
      {
        ...
        cells: [
          ...
          <Link to="/interviews" className="inline-flex items-center gap-1 text-[10px] font-bold text-[#635BFF] uppercase tracking-wider font-mono">
      ...
      },
      {
        ...
        cells: [
          ...
          <Link to="/assignments" className="inline-flex items-center gap-1 text-[10px] font-bold text-[#635BFF] uppercase tracking-wider font-mono">
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-[#111111] px-6 py-12 max-w-6xl mx-auto flex flex-col gap-10 font-sans">
      ...
      <div className="border-b border-[#111111]/10 pb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4 luxe-reveal">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-[#635BFF]" /> {/* Signature Accent Pip */}
            <span className="text-[10px] font-bold text-[#555555] uppercase tracking-widest font-mono">Diagnostic Report</span>
          </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold bg-white border border-[#111111]/10 text-[#555555] rounded-xl hover:bg-black/5 hover:border-black/20 transition-all font-mono"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 luxe-reveal">
        {loading ? (
          ...
          <div className="col-span-3 flex flex-col items-center justify-center py-24 text-center border border-dashed border-[#111111]/10 rounded-2xl bg-white shadow-[0_4px_20px_rgba(17,17,17,0.005)]">
            ...
            <h3 className="text-sm font-bold text-[#111111] uppercase tracking-wider font-mono mb-2">Diagnostic Data Missing</h3>
          ...
          <div className="bg-white border border-[#111111]/7 rounded-2xl p-6 md:p-8 shadow-[0_4px_30px_rgba(17,17,17,0.015)] flex flex-col gap-6">
            <div className="flex items-center justify-between border-b border-[#111111]/5 pb-4">
              ...
              {summary.adaptiveFeedbackTriggered && (
                <span className="text-[9px] font-bold px-2 py-0.5 bg-amber-500/10 text-[#855800] border border-[#855800]/20 rounded uppercase tracking-wider font-mono">
                  Feedback Active
                </span>
              )}
            </div>
